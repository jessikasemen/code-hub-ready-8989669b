-- Portal-Design (Login/Registrierung im Mitarbeiter-Portal) pro Tenant.
-- Auswahl erfolgt im Landing-Generator (nur Fast-Track).
-- Anwenden auf Backend 123:
