...
-- ============================================================================
-- Umbuchen loest die Erinnerungssperre.
-- Die Terminerinnerungen sind pro (application_id, reminder_kind) eindeutig.
-- Nach einer Umbuchung galt die Erinnerung des ALTEN Termins als "schon
-- verschickt" -> der Bewerber bekam fuer den neuen Termin weder die 24h- noch
-- die 30-Minuten-Mail. book_appointment_by_token raeumt diese Zeilen jetzt auf.
-- Basis: 20260727000000_booking_allow_rebook.sql (unveraendert bis auf DELETE).
-- ============================================================================
...
BEGIN
  ...
  -- Erinnerungssperre des alten Termins entfernen (siehe Kopfkommentar).
  DELETE FROM public.application_reminder_log AS l
   WHERE l.application_id = app.id
     AND l.reminder_kind IN (
