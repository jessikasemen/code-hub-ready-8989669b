-- Vertragsarten je Mandant: welche Beschäftigungsarten die Registrierung anbietet.
-- Bestandsmandanten behalten alle drei Arten.
ALTER TABLE public.tenants
  ADD COLUMN IF NOT EXISTS allowed_employment_types text[] NOT NULL
  DEFAULT ARRAY['minijob','teilzeit','vollzeit']::text[];
